...
namespace BankMatilda.Migrations
{
    ...
    [Migration("20210427124646_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankMatilda.Data.Account", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.Card", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.Customer", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.Disposition", b =>
                {
                    b.Property<int>("DispositionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BankMatilda.Data.Loan", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.PermenentOrder", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.Transaction", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.User", b =>
                {
            ...
            modelBuilder.Entity("BankMatilda.Data.Card", b =>
                {
                    b.HasOne("BankMatilda.Data.Disposition", "Disposition")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("BankMatilda.Data.Disposition", b =>
                {
                    b.HasOne("BankMatilda.Data.Account", "Account")
                        .WithMany("Dispositions")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BankMatilda.Data.Customer", "Customer")
                        .WithMany("Dispositions")
            ...
            modelBuilder.Entity("BankMatilda.Data.Transaction", b =>
                {
                    b.HasOne("BankMatilda.Data.Account", "AccountNavigation")
